...
app.layout = html.Div(children=[
    html.Div(className="banner", children=[
        html.Div(className='container scalable', children=[
            html.H2(html.A(
                'Support Vector Machine (SVM) Visualiser by Sarthak Kundu',
                href='https://github.com/MarcusKLuciano/SVM-Visualiser',
                style={
                    'text-decoration': 'none',
                    'color': 'inherit'
                }
            )),
            html.Div(html.A('Inspired by a Project from MIT',
                            style={
                                'text-decoration': 'none',
                                'color': 'inherit'}
            )),
        ...
        html.Div(className='row', children=[
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        dcc.Markdown(dedent("""
                        [Click here](https://sites.google.com/view/sarthak-info/home) to visit my profile.
                        """)),
